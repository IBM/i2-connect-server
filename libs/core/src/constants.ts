...
// TODO: remove this static path (once figured out a way to inject into the loader service)
export const CONNECTORS_HOME = path.normalize(path.join(process.cwd(), 'libs/connectors'));
